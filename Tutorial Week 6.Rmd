...
$$
Now, we substitute the regression coefficients into this formula. The `align*` environment provides a clean, step-by-step simplification:
...
This proves that the coefficient on the interaction term, $\beta_3$, is mathematically identical to the Difference-in-Differences estimate $\delta$.
---
