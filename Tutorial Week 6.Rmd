...
pro_labels <- c(
  "Coca-Growing Region",              # for 'grow'
  "Year (Linear) &times; Growing Region", # for 'year:grow' (use &times; for HTML)
  "1991 &times; Growing Region",          # for 'factor(year)1991:grow'
  "1992 &times; Growing Region",          # for 'factor(year)1992:grow'
  "1993 &times; Growing Region",          # for 'factor(year)1993:grow'
